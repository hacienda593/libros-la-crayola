...
export default function HomePage() {
  ...
  const [modal, setModal]         = useState<LibroDisponible | null>(null);
  ...
  useEffect(() => {
    async function cargar() {
      ...
      (entradas as StockEntrada[] ?? []).forEach(e => {
  ...
  function comprar(l: LibroDisponible) {
    setModal(l);
  }
    ...
    <main className="min-h-screen bg-zinc-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        {librosFiltrados.length === 0 ? (
          <p className="text-center text-zinc-400 font-bold py-12">No hay libros con stock disponibles.</p>
        ) : (
                ...
                <div className="p-3 flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500 uppercase tracking-[0.2em] mt-1">Stock: {l.disponible}</p>
                    </div>
